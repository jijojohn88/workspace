...
public class BTreePrinterTest {
    ...
    private static Node<String> test2() {
        ...
        Node<String> n31 = new Node<String>("g");
        Node<String> n32 = new Node<String>("h");
        Node<String> n33 = new Node<String>("i");
...
class BTreePrinter {
    ...
    public static <T extends Comparable<?>> void printNode(Node<T> root) {
        int maxLevel = BTreePrinter.findMaxTreeLevel(root);
    ...
    private static <T extends Comparable<?>> int findMaxTreeLevel(Node<T> node) {
        if (node == null)
            return 0;
        return Math.max(BTreePrinter.findMaxTreeLevel(node.left), BTreePrinter.findMaxTreeLevel(node.right)) + 1;
    }
